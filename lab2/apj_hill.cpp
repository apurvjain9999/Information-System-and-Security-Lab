...
void mul(int *calc, int key[3][3], int k, int *ans)
{
    int i = 0;
    int j = 0;
    int l = 0;
...
void inverse (int key[3][3], int in[3][3], int k, int t)
{
    int temp[k][k];
    if (k == 2)
    {
...
void encrypt(int key[3][3], string P, ofstream &ofile, int k)
{
    //cout<<P<<"\n";
    string mod = "";
    char *C;
...
void decrypt(int key[3][3], int k, const char C[], int l, ostream &ofile)
{
    char *P = new char[k+1];
    int i=0;
    int j;
