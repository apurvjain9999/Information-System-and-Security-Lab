...
void encrypt(char **key, string P, ofstream &ofile, int kf)
{
    string mod = "";
    int i = 0;
    int k = P.length();
...
void decrypt(char **key, string C, ofstream &ofile, int kf)
{
    int i = 0;
    int g = 0;
    int h = 0;
